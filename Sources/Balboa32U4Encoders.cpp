...
int32_t Balboa32U4Encoders::getCountsLeft()
{
    init();
...
int32_t Balboa32U4Encoders::getCountsRight()
{
    init();
...
int32_t Balboa32U4Encoders::getCountsAndResetLeft()
{
    init();
...
int32_t Balboa32U4Encoders::getCountsAndResetRight()
{
    init();
