 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Jun 23 18:13:46 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                RpArdComm
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                rp_data
#define OUTPUT_0_DIMS_ND               {8,1}
...
extern void RpArdComm_Outputs_wrapper(const uint8_T *a_data,
  uint8_T *rp_data,
  const real_T *xD,
  const uint8_T *pin, const int_T p_width0);
extern void RpArdComm_Update_wrapper(const uint8_T *a_data,
  uint8_T *rp_data,
  real_T *xD,
  const uint8_T *pin, const int_T p_width0);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port a_data of S-Function RpArdComm");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port rp_data of S-Function RpArdComm");
      return;
    }
...
{
  const uint8_T *a_data = (uint8_T *) ssGetInputPortRealSignal(S, 0);
  uint8_T *rp_data = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
  const real_T *xD = ssGetDiscStates(S);
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const uint8_T *pin = (const uint8_T *) mxGetUint8s(PARAM_DEF0(S));
  RpArdComm_Outputs_wrapper(a_data, rp_data, xD, pin, p_width0);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const uint8_T *pin = (const uint8_T *) mxGetUint8s(PARAM_DEF0(S));
  RpArdComm_Update_wrapper(a_data, rp_data, xD, pin, p_width0);
}
