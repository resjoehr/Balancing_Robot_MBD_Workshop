 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Dec 18 14:16:16 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                ReadEncoders
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port left of S-Function ReadEncoders");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port right of S-Function ReadEncoders");
      return;
    }
...
{
  real32_T *left = (real32_T *) ssGetOutputPortRealSignal(S, 0);
  real32_T *right = (real32_T *) ssGetOutputPortRealSignal(S, 1);
  const real_T *xD = ssGetDiscStates(S);
  ReadEncoders_Outputs_wrapper(left, right, xD);
}
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  ReadEncoders_Update_wrapper(left, right, xD);
}
